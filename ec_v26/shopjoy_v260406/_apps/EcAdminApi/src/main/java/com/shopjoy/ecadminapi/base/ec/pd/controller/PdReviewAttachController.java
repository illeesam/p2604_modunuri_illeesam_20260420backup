...
public class PdReviewAttachController {
    ...
    public ResponseEntity<ApiResponse<PageResult<PdReviewAttachDto>>> page(
        ...
        Map<String, Object> p = buildParam(siteId, kw, dateStart, dateEnd, sort);
        PageResult<PdReviewAttachDto> result = service.getPageData(p, pageNo, pageSize);
        return ResponseEntity.ok(ApiResponse.ok(result));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<PdReviewAttachDto>> getById(@PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<PdReviewAttach>> save(
            @PathVariable String id, @RequestBody PdReviewAttach entity) {
