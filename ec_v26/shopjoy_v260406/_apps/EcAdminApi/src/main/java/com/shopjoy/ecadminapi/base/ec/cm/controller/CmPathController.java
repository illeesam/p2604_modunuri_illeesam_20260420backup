...
public class CmPathController {
    ...
    public ResponseEntity<ApiResponse<PageResult<CmPathDto>>> page(
        ...
        Map<String, Object> p = buildParam(siteId, kw, dateStart, dateEnd, sort);
        PageResult<CmPathDto> result = service.getPageData(p, pageNo, pageSize);
        return ResponseEntity.ok(ApiResponse.ok(result));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<CmPathDto>> getById(@PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<CmPath>> save(
            @PathVariable String id, @RequestBody CmPath entity) {
        entity.setBizCd(id);
