...
public class PmCouponItemController {
    ...
    public ResponseEntity<ApiResponse<PageResult<PmCouponItemDto>>> page(
        ...
        Map<String, Object> p = buildParam(siteId, kw, dateStart, dateEnd, sort);
        PageResult<PmCouponItemDto> result = service.getPageData(p, pageNo, pageSize);
        return ResponseEntity.ok(ApiResponse.ok(result));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<PmCouponItemDto>> getById(@PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<PmCouponItem>> save(
            @PathVariable String id, @RequestBody PmCouponItem entity) {
