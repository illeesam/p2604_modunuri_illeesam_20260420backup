/* ShopJoy Admin - 전시영역미리보기 (#page=ecDispWidgetLibPreview) */

/* ── 위젯미리보기 서브컴포넌트 (grid · dashboard 공용) ── */
const _WP_DispAreaPreview2 = {
  name: 'WidgetPreview',
...
<div>
  ...
  <div class="page-title" style="display:flex;align-items:center;justify-content:space-between;">
    <div>
      전시영역미리보기
      <span style="font-size:13px;font-weight:400;color:#888;">영역 트리 & 드래그하여 배치</span>
    </div>
            ...
            <div v-for="sub in node.children" :key="node.label+'_'+sub.label">
              ...
              <template v-if="isOpen(node.label+'_'+sub.label)">
                <div v-for="lib in sub.libs" :key="lib.libId"
                  ...
                  <span style="font-size:9px;background:#e8f0fe;color:#1a73e8;border-radius:4px;padding:1px 6px;font-weight:600;flex-shrink:0;white-space:nowrap;">(영역)</span>
  ...
  `,
  components: {
    WidgetPreview: _WP_DispAreaPreview2,
  },
};
