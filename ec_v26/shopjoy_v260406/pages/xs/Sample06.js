...
window.XsSample06 = {
  ...
  setup() {
    ...
    const onSearch = () => { Object.assign(applied, { kw: searchKw.value, discountType: searchDiscountType.value, useYn: searchUseYn.value }); loadGrid(); };
    const onReset  = () => { searchKw.value = ''; searchDiscountType.value = ''; searchUseYn.value = ''; Object.assign(applied, { kw: '', discountType: '', useYn: '' }); loadGrid(); };
...
<div style="padding:clamp(12px,3vw,24px);">
  ...
  <div style="background:#fff;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;">
    <div style="display:flex;align-items:center;justify-content:space-between;padding:8px 12px;border-bottom:1px solid #f0f0f0;">
      <span style="font-size:12px;font-weight:700;">쿠폰 목록 <span style="color:#e8587a;margin-left:4px;">{{ total }}건</span></span>
    ...
    <div style="overflow-x:auto;">
      <table style="width:100%;border-collapse:collapse;font-size:12px;min-width:820px;">
        ...
        <tbody>
          ...
          <tr v-for="(row,idx) in pagedRows" :key="row.couponId"
