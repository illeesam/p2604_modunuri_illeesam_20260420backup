...
<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:80px 20px;text-align:center;min-height:60vh;">
  ...
  <div v-if="message" style="font-size:12px;color:#c62828;margin-top:12px;font-family:monospace;background:#fff5f5;padding:8px 14px;border-radius:6px;max-width:600px;word-break:break-all;">{{ message }}</div>
